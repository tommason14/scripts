...
print("./plusX/gdma/gdma.out")
print("./plusY/gdma/gdma.out")
print("./plusZ/gdma/gdma.out")
print("./minusX/gdma/gdma.out")
print("./minusY/gdma/gdma.out")
print("./minusZ/gdma/gdma.out")
answer=input("............ yes/no   ")       # Ask whether to use default directory / enter own path

if answer=="yes":
    print("Reading files...")
    try:
        read_input_x = open("plusX/gdma/gdma.out",'r')
        read_input_y = open("plusY/gdma/gdma.out",'r')
        read_input_z = open("plusZ/gdma/gdma.out",'r')
        read_input_mx = open("minusX/gdma/gdma.out",'r')
        read_input_my = open("minusY/gdma/gdma.out",'r')
        read_input_mz = open("minusZ/gdma/gdma.out",'r')
    except FileNotFoundError:
        print("---------------------------------------------------------")
        sys.exit("File not found. Please check the corresponding paths.")
else:
