...
parser.add_argument(
    ...
    '--viscosity',
    help=
    'Shear viscosity of the solvent, in mPas. Default = 1 (assuming water)',
    default=1,
    type=float)
...
corrected = (k * args.temperature *
             CONS) / (6 * pi * args.viscosity * MPAS_TO_PAS * args.box *
                      ANGSTROMS_TO_M) * SQUARE_METRES_TO_SQUARE_CM
